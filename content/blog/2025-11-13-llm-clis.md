...
tags = ["ai","cli","developer tools","lab notes",]
+++
...
## System Prompts: Three Different Conventions
...
## Commands: Even More Fragmentation
...
Claude and Codex support namespacing via subdirectories[^6][^7], while Gemini only looks at top-level files[^8].

## My Workaround: Symlinks to the Rescue
